...
const PasswordChange = () => {
  ...
  return (
    <div className="w-full  xl:w-[80%] h-130 xl:h-120 border-b border-gray-200  px-10 py-3 flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-5" >
       ...
       <div className="flex flex-col gap-0.5">
        ...
        <input type="password" value={confirmPassword}  className="border border-gray-200 w-120 h-10 rounded-xl px-2 outline-none" id="confirm" placeholder="enter your confirm password" onChange={(e)=>setConfirmPassword(e.target.value)}/>
       </div>
